...
class Chest extends Entity {
    ...
    draw(ctx) {
        ...
        const totalH = this.beamH + this.height;
        const totalW = Math.max(this.beamBaseW, this.width) + 24;
        if (!rectInView(this.x, this.y - this.beamH / 2, totalW, totalH)) { ctx.restore(); return; }
