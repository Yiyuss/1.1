...
const ResourceLoader = {
    ...
    getImageList() {
        return [
            ...
            { name: 'player7', src: 'assets/images/player7.png' },
            { name: 'player7-1', src: 'assets/images/player7-1.png' },
            { name: 'player7-2', src: 'assets/images/player7-2.png' },
            { name: 'player7-3', src: 'assets/images/player7-3.png' },
            { name: 'player8', src: 'assets/images/player8.png' },
            { name: 'player8-1', src: 'assets/images/player8-1.png' },
            { name: 'player8-2', src: 'assets/images/player8-2.png' },
            { name: 'player8-3', src: 'assets/images/player8-3.png' },
            { name: 'player9', src: 'assets/images/player9.png' },
            { name: 'player9-2', src: 'assets/images/player9-2.png' },
            { name: 'player9-3', src: 'assets/images/player9-3.png' },
            ...
            { name: 'elf-2', src: 'assets/images/Elf-2.png' },
            { name: 'elf2-2', src: 'assets/images/Elf2-2.png' },
            { name: 'elf3-2', src: 'assets/images/Elf3-2.png' },
            { name: 'elf_mini_boss', src: 'assets/images/Elf_mini_boss.png' },
            { name: 'elf_mini_boss-3', src: 'assets/images/Elf_mini_boss-3.png' },
            ...
            { name: 'A38', src: 'assets/images/A38.png' },
            { name: 'A39', src: 'assets/images/A39.png' },
            { name: 'A40', src: 'assets/images/A40.png' },
            { name: 'A43', src: 'assets/images/A43.png' },
            { name: 'A45', src: 'assets/images/A45.png' },
            { name: 'A56', src: 'assets/images/A56.png' },
            { name: 'A71', src: 'assets/images/A71.png' },
            ...
            { name: 'A60', src: 'assets/images/A60.png' },
            { name: 'A61', src: 'assets/images/A61.png' },
            { name: 'A62', src: 'assets/images/A62.png' },
            { name: 'A63', src: 'assets/images/A63.png' },
            { name: 'A64', src: 'assets/images/A64.png' },
            { name: 'A75', src: 'assets/images/A75.png' },
            { name: 'A76', src: 'assets/images/A76.png' },
            ...
            { name: 'background13', src: 'assets/images/background13.jpg' },
            ...
            { name: 'human-2', src: 'assets/images/human-2.png' },
            { name: 'human2-2', src: 'assets/images/human2-2.png' },
            { name: 'human3-2', src: 'assets/images/human3-2.png' },
            { name: 'human_mini_boss', src: 'assets/images/human_mini_boss.png' },
            { name: 'humanboss', src: 'assets/images/humanboss.png' },
            { name: 'human_mini_boss-2', src: 'assets/images/human_mini_boss-2.png' },
            { name: 'humanboss-2', src: 'assets/images/humanboss-2.png' },
            { name: 'unknown', src: 'assets/images/unknown.png' },
            { name: 'unknown2', src: 'assets/images/unknown2.png' },
            { name: 'unknown3', src: 'assets/images/unknown3.png' },
            { name: 'unknown_mini_boss', src: 'assets/images/unknown_mini_boss.png' },
            { name: 'unknownboss', src: 'assets/images/unknownboss.png' },
    ...
    getMusicList() {
        return [
            ...
            { name: 'game_music3', src: 'assets/audio/game_music3.mp3' },
