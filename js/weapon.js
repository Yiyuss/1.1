...
(function () {
    ...
    try {
        class Weapon {
            ...
            update(deltaTime) {
                // 抽象化、第六感、不獸控制、心意相通、腎上腺素、虹光共鳴是被動技能，不需要發射
                if (this.type === 'ABSTRACTION' || this.type === 'SIXTH_SENSE' || this.type === 'PON' || this.type === 'UNCONTROLLABLE_BEAST' || this.type === 'HEART_CONNECTION' || this.type === 'ADRENALINE' || this.type === 'RAINBOW_RESONANCE') {
