      ...
      try {
        if (typeof Game !== 'undefined' && Array.isArray(Game.projectiles)) {
          for (let i = Game.projectiles.length - 1; i >= 0; i--) {
            ...
            if (wt === 'GRAVITY_WAVE' || wt === 'AURA_FIELD' || wt === 'STELLAR_FIELD' || wt === 'ORBIT' || wt === 'CHICKEN_BLESSING' || wt === 'ROTATING_MUFFIN' || wt === 'HEART_COMPANION' || wt === 'PINEAPPLE_ORBIT' || wt === 'GABRIEL_ORBIT' || wt === 'LASER' || wt === 'RADIANT_GLORY') {
