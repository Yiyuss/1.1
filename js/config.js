    ...
    TUNING: {
        ...
        MINI_BOSS: {
            ...
            desert: {
                ...
                // 修羅模式：小BOSS 4000-80000（第1波4000，第30波80000）
                ASURA: {
                    startWave1: 4000,      // 第1波血量
                    endWave30: 80000       // 第30波血量
                }
            },
            // 第四張地圖：花園 (garden)
            garden: {
                // 簡單模式：花護衛小BOSS 3000-35000（第1波3000，第30波35000，提升以確保明顯高於普通小怪）
                EASY: {
                    startWave1: 3000,      // 第1波血量（提升起始值，確保前期就高於普通小怪）
                    endWave30: 35000       // 第30波血量（提升結束值，確保後期明顯高於普通小怪的10000）
                },
                // 困難模式：花護衛小BOSS 5000-150000（第1波5000，第30波150000，提升以確保明顯高於普通小怪）
                HARD: {
                    startWave1: 5000,      // 第1波血量（提升起始值，確保前期就高於普通小怪）
                    endWave30: 150000      // 第30波血量（提升結束值，確保後期明顯高於普通小怪的15000）
                }
            }
        },
        ...
        BOSS: {
            ...
            city: {
                ...
                // 困難模式：大BOSS 50000
                HARD: {
                    wave20: 50000         // 第20波血量（原第30波，血量不變）
                }
            },
            // 第二張地圖：草原 (forest)
            forest: {
                // 簡單模式：大BOSS 15000
                EASY: {
                    wave20: 15000        // 第20波血量（原第30波，血量不變）
                },
                // 困難模式：大BOSS 70000
                HARD: {
                    wave20: 70000         // 第20波血量（原第30波，血量不變）
                }
            },
            // 第三張地圖：宇宙 (desert)
            desert: {
                // 困難模式：大BOSS 85000
                HARD: {
                    wave20: 85000         // 第20波血量（原第30波，血量不變）
                },
                // 修羅模式：大BOSS 120000
                ASURA: {
                    wave20: 120000        // 第20波血量（原第30波，血量不變）
                }
            },
            // 第四張地圖：花園 (garden)
            garden: {
                // 簡單模式：花女王大BOSS 100000
                EASY: {
                    wave20: 100000         // 第20波血量（原第30波，血量不變）
                },
                // 困難模式：花女王大BOSS 300000
                HARD: {
                    wave20: 300000        // 第20波血量（原第30波，血量不變）
                }
            }
        }
    },
